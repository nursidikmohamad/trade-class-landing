    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#050406] via-[#070708] to-[#0b0b0d]">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center">
        ...
        {/* Benefits / Offer details (cards) */}
          ...
          <h3 className="mx-auto text-2xl md:text-3xl lg:text-4xl font-extrabold mb-6 bg-gradient-to-r from-amber-300 via-amber-200 to-white bg-clip-text text-transparent text-center">Bonus Yg Anda Dapatkan Saat Mengikuti Kelas.</h3>
